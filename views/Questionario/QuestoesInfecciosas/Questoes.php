<?php 
    ...
    if(!isset($_SESSION['logado'])){
         echo"<scrip language='javascript' type='text/javascript'>
                alert('Acesso negado. Realize o login');
                window.location.href='./Login.html';</scrip>";
    }
?>
...
<body>
    ...
    <div class = "container4">
        ...
        <div class="home-box custom-box">
            ...
            <div class="btnComecar">
                <h3>Total de questões:<span class="total-questions"></span></h3>
                <button type="button" class="btn btn-third" onclick="startQuiz()">Começar</button>
            </div>
        </div>
        <div class="quiz-box custom-box hide"> 
            ...
            <div class="next-question-btn">
                <button type="button" class="btn btn-third" onclick = "teste()">Próxima</button>
            </div>
        ...
        <div class="result-box custom-box hide">
            ...
            <div class="btnTenteNovamente">
                <button type="button" class="btn btn-third" onclick = "tryAgainQuiz()" >Tente novamente</button>
                <button type="button" class="btn btn-third" onclick = "goToNextQuiz()">Próximo questionário</button>
            </div>
        </div>
    </div> 
    </br>
    ...
    <script src="../../../js/questionInfecciosas.js"></script>
