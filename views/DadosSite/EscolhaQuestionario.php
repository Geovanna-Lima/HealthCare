    ...
    <div class = "container4">
		...
		<div class="card-content">
			<div class="card-doenca">
				...
				<div class="stat">
					<div class="type">
						<a href="../Questionario/QuestoesRespiratorias/Questoes.php">RESPONDER</a>
					</div>
				</div>
				</div>
			</div>
			<div class="card-doenca">
				...
				<div class="stat">
					<div class="type">
						<a href="../Questionario/QuestoesInfecciosas/Questoes.php">RESPONDER</a>
					</div>
				</div>
				</div>
			</div>
			<div class="card-doenca">
				...
				<div class="stat">
					<div class="type">
						<a href="../Questionario/QuestoesTranstornos/Questoes.php">RESPONDER</a>
					</div>
				</div>
				</div>
			</div>
